...
\begin{equation}
  ...
  \label{eq:emp_dist}
\end{equation}
其中 $\delta_{\bm{f}}$ 为 Dirac 测度。1-Wasserstein 距离定义为
\begin{equation}
  W_1(\mu,\nu) = \inf_{\pi\in\Pi(\mu,\nu)}

...
- **Publication-ready paper**: 83-page LaTeX paper (Chinese) meeting CUMCM national-first-prize
...
优化建议/  Feasibility analysis and audit evidence (Chinese)
...
Python 3.13; dependencies pinned in `pyproject.toml` (`ultralytics==8.4.110`,
`torch==2.13.0`). Set `YOLO_CONFIG_DIR` to a writable directory if Ultralytics settings fail.
